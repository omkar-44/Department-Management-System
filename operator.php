...
$result = mysqli_query($con,"select * from operator where username='$username' && password='$password'");
...
<input type="Username" class="form-control" name="user" placeholder="Username" name="user">
